...
from prompts import sql_reasoning_prompt   # already defined by you

HERE      = pathlib.Path(__file__).resolve().parent          # .../utils
DATA_DIR  = HERE.parent / "open_r1/data_processing"                  # .../data_processing
SQL_DIR   = DATA_DIR / "sql_files/dev"
IN_FILE   = DATA_DIR / "dev.json"
OUT_FILE  = DATA_DIR / "dev_with_prompt.json"
